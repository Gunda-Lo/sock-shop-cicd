module "eks" {
 ...
 vpc_id     = var.existing_vpc_id  # Use the existing VPC ID
  subnet_ids = [
    module.eks-vpc.private_subnets[0],  # Reference the ID of the private subnet created above
    module.eks-vpc.public_subnets[0],   # Reference the ID of the public subnet created above
  ]
